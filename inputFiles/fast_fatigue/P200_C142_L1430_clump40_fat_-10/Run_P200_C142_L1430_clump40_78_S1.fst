...
---------------------- INPUT FILES --------------------------------------------- 
"IEA-15-240-RWT-UMaineSemi_ElastoDyn_Run_P200_C142_L1430_clump40_78_S1.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"IEA-15-240-RWT_InflowFile_Run_P200_C142_L1430_clump40_78_S1.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
"IEA-15-240-RWT-UMaineSemi_AeroDyn15.dat" AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"IEA-15-240-RWT-UMaineSemi_ServoDyn_Run_P200_C142_L1430_clump40_78_S1.dat" ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
"IEA-15-240-RWT-UMaineSemi_SeaState_Run_P200_C142_L1430_clump40_78_S1.dat" SeaStFile   - Name of file containing sea state input parameters (quoted string)
"IEA-15-240-RWT-UMaineSemi_HydroDyn_Run_P200_C142_L1430_clump40_78_S1.dat" HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)
"none"                 SubFile     - Name of file containing sub-structural input parameters (quoted string)
"Moordyn_P200_C142_L1430_clump40_78.dat" MooringFile - Name of file containing mooring system input parameters (quoted string)

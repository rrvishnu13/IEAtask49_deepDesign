...
---------------------- INPUT FILES --------------------------------------------- 
"IEA-15-240-RWT-UMaineSemi_ElastoDyn_Run_P200_C135_L1430_clump40_2_S4.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"IEA-15-240-RWT_InflowFile_Run_P200_C135_L1430_clump40_2_S4.dat" InflowFile    - Name of file containing inflow wind input parameters (quoted string)
...
"IEA-15-240-RWT-UMaineSemi_HydroDyn_Run_P200_C135_L1430_clump40_2_S4.dat" HydroFile     - Name of file containing hydrodynamic input parameters (quoted string)
"none"        SubFile       - Name of file containing sub-structural input parameters (quoted string)
"Moordyn_P200_C135_L1430_clump40_2.dat" MooringFile   - Name of file containing mooring system input parameters (quoted string)
